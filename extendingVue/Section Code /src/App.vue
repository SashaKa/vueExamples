        ...
        <form>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
                    ...
                    <br>
                    <textarea id="message" rows="5" class="form-control" v-model="massage"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
                    ...
                    <select id="priority" class="form-control" v-model="selectedPriority">
                        <option v-for="priority in prioritis"> {{ priority }}</option>
                    </select>
                </div>
            </div>
            <div class="row">
    ...
    export default {
        data() {
            return {
                ...
                massage: ' Something message here',
                sendMail: [],
                gender: 'female',
                selectedPriority: 'highest',
                prioritis: ['low', 'medium', 'highest'],
                dataSwitch: true,
                isSubmitted: false
            }
        },
